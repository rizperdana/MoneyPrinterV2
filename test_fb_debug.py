#!/usr/bin/env python3
"""Test just Facebook upload - with debug output"""
...
print("Got firefox profile path")

from classes.YouTube import YouTube

print("Imported YouTube")
...
print("Creating YouTube instance...")
youtube = YouTube(
...
print("YouTube instance created")
...
print("Calling upload_to_facebook...")
